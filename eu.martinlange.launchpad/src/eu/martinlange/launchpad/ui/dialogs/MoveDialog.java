...
public class MoveDialog extends TitleAreaDialog {
	...
	private ConfigurationTreeNode fElement;

	private FilteredTree fTree;
	private TreeViewer fViewer;


	public MoveDialog(Shell shell, ConfigurationTreeNode element) {
		super(shell);
		fElement = element;
	}
	...
	protected void okPressed() {
		...
		if (selection instanceof IStructuredSelection && !selection.isEmpty()) {
			ConfigurationTreeNode element = (ConfigurationTreeNode) ((IStructuredSelection) selection).getFirstElement();
	...
	protected boolean isValid() {
		...
		ConfigurationTreeNode parent = (ConfigurationTreeNode) selection.getFirstElement();
