package eu.martinlange.tools.eclipse.launch.commands;
...
public class LaunchCommandHandler extends AbstractHandler implements IHandler {
	...
	public static final String COMMAND_ID = "eu.martinlange.command.launch";
	public static final String PARAMETER_ID = "eu.martinlange.command.launch.mode";
